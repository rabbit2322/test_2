...
if st.session_state.page == "instruction":
    ...
    st.markdown("""
    ### 💡 실험 진행 방식
    본 실험은 총 <b>3개의 단계<b>로 구성되어 있으며, 갈수록 기억해야 하는 항목이 많아집니다.
    * <b>1단계 (Block 1):<b> 총 3개의 문장 판단 + 3개의 글자 기억
    * <b>2단계 (Block 2):<b> 총 5개의 문장 판단 + 5개의 글자 기억
    * <b>3단계 (Block 3):<b> 총 7개의 문장 판단 + 7개의 글자 기억
    
    ### 🕹️ 세부 수행 흐름
    1. 화면에 문장이 제시되면 문맥이 올바른지 <b>⭕(TRUE)<b> 또는 <b>❌(FALSE)<b> 버튼을 눌러 빠르게 판단합니다.
    2. 문장 판단 직후 화면에 <b>알파벳 자음 한 글자<b>가 0.5초 동안 나타났다 사라집니다. 이 글자를 순서대로 머릿속에 기억하셔야 합니다.
    3. 지정된 세트가 끝나면 키패드가 나타납니다. 방금 보았던 알파벳들을 <b>나타났던 순서 그대로<b> 클릭하여 입력해 주세요.
    """)
